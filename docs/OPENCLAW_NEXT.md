...
- noVNC hardened: Xvfb socket wait, novnc_probe readiness, ensure_novnc_ready before WAITING_FOR_HUMAN, NOVNC_BACKEND_UNAVAILABLE fail-closed with journal link.
