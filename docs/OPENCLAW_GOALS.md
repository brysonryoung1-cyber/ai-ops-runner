...
- **pred_markets phase0 mirror**: Read-only snapshot of Kalshi + Polymarket public market data into canonical artifacts; no order placement, no wallets, no API keys that enable trading. Kill switch default ON.
