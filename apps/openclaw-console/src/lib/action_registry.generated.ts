...
export const PROJECT_ACTIONS: Record<string, ReadonlySet<string>> = {
  "soma_kajabi": new Set(["soma_connectors_status", "soma_kajabi_bootstrap_finalize", "soma_kajabi_bootstrap_start", "soma_kajabi_bootstrap_status", "soma_kajabi_discover", "soma_kajabi_gmail_connect_finalize", "soma_kajabi_gmail_connect_start", "soma_kajabi_gmail_connect_status", "soma_kajabi_snapshot_debug", "soma_zane_finish_plan"]),
};
